...
--	end
	...
	render.DrawQuadEasy(Vector(256,256,0),Vector(0,0,-1),modelscale*512*irissize,modelscale*512*irissize,Color(color.x*255,color.y*255,color.z*255,255),-90) --position of the rect
	--direction to face in
	--size of the rect
	--color
	--rotate 90 degrees
	...
	render.SetMaterial(material)
	render.DrawQuadEasy(Vector(256,256,0),Vector(0,0,-1),modelscale*512*irissize,modelscale*512*irissize,Color(colorg.x*255,colorg.y*255,colorg.z*255,255),-90) --position of the rect
	...
	render.SetMaterial(material)
	render.DrawQuadEasy(Vector(256,256,0),Vector(0,0,-1),modelscale*512*holesize*holewidth,modelscale*512*holesize,Color(holecol.x*255,holecol.y*255,holecol.z*255,255),-90) --position of the rect
	--direction to face in
	--size of the rect
	--color
	--rotate 90 degrees
	...
	render.SetMaterial(material)
	render.DrawQuadEasy(Vector(256,256,0),Vector(0,0,-1),modelscale*512*irissize,modelscale*512*irissize,Color(255,255,255,255),-90) --position of the rect
	--direction to face in
	--size of the rect
	--color
	--rotate 90 degrees
	...
	--]=]
	render.SetMaterial(material)
	render.DrawQuadEasy(Vector(256,256,0),Vector(0,0,-1),modelscale*512*irissize,modelscale*512*irissize,Color(255,255,255,255*0.5),-90) --position of the rect
	--direction to face in
	--size of the rect
	--color
	--rotate 90 degrees
