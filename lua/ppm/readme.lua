...
'ppm_height_min',
'default 0',
'minimum for leg and neck scaling',
'can be set as high as 0.99',
'can be set as low as -4',
'_________________________________________________________________________________________',
'',
'ppm_height_max',
'default 3',
'maximum for leg and neck scaling',
'can be set as high as 7',
'can be set as low as 1.01',
'_________________________________________________________________________________________',
'',
'ppm_scale_min',
'default 0.5',
'minimum for model scaling',
'can be set as high as 0.99 ',
'can be set as low as 0.01',
'_________________________________________________________________________________________',
'',
'ppm_scale_max',
'default 1.5',
'maximum for model scaling',
'can be set as high as 4',
'can be set as low as 1.01',
'_________________________________________________________________________________________',
'',
